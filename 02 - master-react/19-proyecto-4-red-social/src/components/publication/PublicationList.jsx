...
export const PublicationList = ({publications, getPublicaciones, page, setPage, more, setMore}) => {
  ...
  return (
    ...
    {publications && publications.map(publication => {
        return (
            <article className="posts__post" key={publication.created_at}>
                ...
                <div className="post__container">
                    ...
                    <div className="post__body">
                        ...
                        {publication.file && <img className='post-img' src={Global.url + "publication/media/" + publication.file}/>}
